...
const StringComponent = ({
  ...
  return (
    <div className="w-full flex flex-col items-start overflow-x-auto styled-scrollbar pb-8 pt-2 px-2">
      ...
      >
        {/* Opening Quote */}
        <span className="text-accent/60 text-3xl font-mono font-light leading-none mr-3 self-center translate-y-2">"</span>
        ...
        <div className="flex items-start">
          ...
          {safeValue.map((val, idx) => {
            ...
            let borderClass = "border border-b-[3px] border-border/80 hover:border-accent/50 hover:bg-accent/5";
        ...
        {/* Closing Quote */}
        <span className="text-accent/60 text-3xl font-mono font-light leading-none ml-3 self-center translate-y-2">"</span>
      </motion.div>
    </div>
  );
};

        ...
        <AnimatePresence>
          {[...edges]
            ...
            .map((edge) => {
              ...
              if (isRead) {
                strokeCls = "stroke-accent opacity-100";
                strokeW = 2.5;
                markerId = "arr-read";
              } else if (isHighlight) {
                strokeCls = "stroke-accent-2 opacity-100";
                strokeW = 2;
                markerId = "arr-highlight";
              }
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none z-10">
        <AnimatePresence mode="popLayout">
          {nodes.map((node) => {
            ...
            if (isDelete) {
              bgCls = "bg-failure/20 backdrop-blur-sm";
              borderCls = "border-failure";
              textCls = "text-failure";
              ringCls = "ring-4 ring-failure/15";
              scale = 0.94;
              zIdx = 10;
            } else if (isWrite) {
              bgCls = "bg-success/25 backdrop-blur-sm";
              borderCls = "border-success";
              textCls = "text-success";
              ringCls = "ring-4 ring-success/20";
              scale = 1.06;
              zIdx = 20;
            } else if (isCompare) {
              ...
              bgCls = "bg-accent/25 backdrop-blur-sm";
              borderCls = "border-accent";
              textCls = "text-accent";
              ringCls = "ring-4 ring-accent/15";
              scale = 1.04;
              zIdx = 10;
            } else if (isHighlight) {
              bgCls = "bg-accent-2/30 backdrop-blur-sm";

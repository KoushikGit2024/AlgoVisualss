        ...
        <table className="w-full text-left border-collapse text-[12.5px]">
          <thead>
            <tr className="bg-surface-2 text-text">
              ...
              <th className="px-4 py-3 border-b border-r border-border font-semibold">
                Data Structure
              </th>
              <th className="px-4 py-3 border-b border-r border-border font-semibold">
                Requirement
          ...
          <tbody>
            <tr className="border-b border-border hover:bg-surface-2/40 transition-colors">
              <td className="px-4 py-3 border-r border-border font-mono text-center text-accent">
                1
              </td>
              <td className="px-4 py-3 border-r border-border font-semibold text-ds-string">
                String
              </td>
              <td className="px-4 py-3 border-r border-border text-muted">
                Raw <code className="text-text">string</code> or{" "}
                <code className="text-text">char[]</code>
              </td>
            ...
            <tr className="border-b border-border hover:bg-surface-2/40 transition-colors">
              ...
              <td className="px-4 py-3 border-r border-border font-semibold text-ds-bitset">
                Bitset
              </td>
              <td className="px-4 py-3 border-r border-border text-muted">
                Raw <code className="text-text">number</code> or{" "}
                <code className="text-text">bool[]</code>
              </td>
              <td className="px-4 py-3 text-muted">Bypasses prefix checking entirely</td>
            </tr>
            <tr className="border-b border-border hover:bg-surface-2/40 transition-colors">
            ...
            <tr className="border-b border-border hover:bg-surface-2/40 transition-colors">
              ...
              <td className="px-4 py-3 border-r border-border font-semibold text-accent-3">
                Stack
              </td>
              <td className="px-4 py-3 border-r border-border text-muted">
            ...
            <tr className="border-b border-border hover:bg-surface-2/40 transition-colors">
              ...
              <td className="px-4 py-3 border-r border-border font-semibold text-accent-2">
                Queue
              </td>
              <td className="px-4 py-3 border-r border-border text-muted">
            ...
            <tr className="border-b border-border hover:bg-surface-2/40 transition-colors">
              ...
              <td className="px-4 py-3 border-r border-border font-semibold text-accent">
                Linked List
              </td>
              <td className="px-4 py-3 border-r border-border text-muted">

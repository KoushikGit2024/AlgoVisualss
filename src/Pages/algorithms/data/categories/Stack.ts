const STACKS_SECTION = {
  ...
  about: [
    ...
    {
      tag: "p",
      text: "A stack is a Last-In-First-Out (LIFO) structure: the only two operations are push (add to the top) and pop (remove from the top), both O(1). Despite this extreme simplicity, stacks underlie an enormous range of algorithms — anywhere a problem has a 'most recent unmatched/unresolved thing' that needs to be remembered until it's explicitly closed off or superseded, a stack is almost always the right tool.",
    },
    {
      tag: "p",
      text: "The single most powerful and recurring stack pattern in this section is the monotonic stack — a stack that's kept strictly increasing or strictly decreasing from bottom to top by popping elements that would violate that order before pushing a new one. It looks like a small variation on a plain stack, but it's what turns an apparently O(n²) 'compare every element to every other element' problem into O(n), because each element is pushed and popped at most once across the entire algorithm.",
    },
    ...
    },
    {
      tag: "note",
      variant: "tip",
      text: "If you find yourself wanting to write a nested loop to compare every element against every later element, stop and ask whether a monotonic stack can do it in one pass instead — the answer is yes surprisingly often.",
    },
  ],
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "A common trick to simplify the matching logic: push the EXPECTED closing bracket (not the opening one) onto the stack when you see an opener — then a closing bracket is valid exactly when it equals stack.pop(), with no separate lookup table needed at comparison time.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Even if the string is invalid and could theoretically be rejected partway through, a single full pass examining every character is still required in general to detect most invalidity conditions correctly — though an early mismatch can trigger immediate rejection.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Every character triggers exactly one O(1) operation — either a push (opening bracket) or a pop-and-compare (closing bracket) — regardless of the specific bracket types or nesting depth involved.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "No string configuration increases the cost beyond examining every character once — even a perfectly valid, maximally nested string (e.g. n/2 opens followed by n/2 matching closes) still requires exactly n character examinations.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "If the string consists entirely of immediately-matching pairs (e.g. '()()()'), the stack never holds more than one element at a time, since each opener is immediately resolved by its closer before the next opener arrives.",
          },
        ...
        average: [
          ...
          {
            tag: "p",
            text: "For typical nested input, the stack can grow proportionally to the nesting depth, which in the average case is some fraction of the total string length.",
          },
          {
            tag: "ul",
            items: [
              "Stack holds up to O(n) unmatched openers at its deepest point, depending on the specific nesting pattern",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "A string consisting of n/2 consecutive opening brackets followed by n/2 closing brackets (maximal nesting depth) pushes every opener onto the stack before any popping begins.",
          },
          {
            tag: "ul",
            items: [
      ...
      pseudoCodeandStepexplanation: [
        { tag: "h1", text: "Pseudocode & Step-by-Step Explanation" },
        {
          tag: "code",
          language: "text",
          text: `function isValidParentheses(strPars):
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "A space-optimised variant only pushes onto the auxiliary stack when the new value is ≤ the current minimum (rather than on every push) — this trades a slightly more complex pop condition for better average-case space usage, while keeping the same O(1) time guarantee.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Every operation — push, pop, top, and getMin — performs a fixed, constant number of stack operations regardless of how many elements are currently stored or what their values are.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Every operation performs the same fixed number of constant-time sub-operations regardless of the values pushed or the stack's current size — there's no value-dependent branching that changes the operation count.",
          },
          {
            tag: "ul",
            items: [
              "All four operations (push, pop, top, getMin) remain strictly O(1), regardless of stack depth or value distribution",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "No sequence of push/pop operations or value distribution increases any operation's cost beyond a fixed constant — this is one of the cleanest examples of a data structure with genuinely uniform O(1) behaviour across all cases.",
          },
          {
            tag: "ul",
            items: [
              "All operations: O(1), identical across best, average, and worst case — there is no degenerate input for this design",
            ],
          },
        ],
      },
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Storing n elements in the main stack always requires O(n) space for the data itself, plus the auxiliary minimum-tracking stack adds proportional overhead.",
          },
          {
            tag: "ul",
            items: ["Main stack: O(n)", "Auxiliary min stack (always-push variant): O(n)"],
          },
        ],
        average: [
          { tag: "h2", text: "Average Case Space — O(n)" },
          {
            tag: "p",
            text: "With the space-optimised variant (only pushing to the auxiliary stack when a new minimum is found), the auxiliary stack's size depends on how often new minimums occur — for randomly ordered pushes, this is typically much smaller than n.",
          },
          {
            tag: "ul",
            items: [
              "Main stack: O(n) always",
              "Optimised auxiliary stack: expected O(log n) for random insertion order (related to the expected number of left-to-right minima in a random permutation), though still O(n) in the worst case",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "If elements are pushed in strictly decreasing order, every single push sets a new minimum, so even the optimised auxiliary stack grows to match the main stack's full size.",
          },
          {
            tag: "ul",
            items: [
...
`,
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "The key insight: process elements left to right, maintaining a stack of indices whose 'next greater element' hasn't been found yet. When a new element arrives that's larger than the stack's top, it IS the next-greater-element for every index it pops off the stack — because those popped elements were all waiting for exactly this: the first larger value to their right.",
        },
        { tag: "h2", text: "When to reach for it" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "The monotonic stack here is decreasing from bottom to top — it only ever holds elements for which a 'next greater' hasn't been found yet, and the moment a bigger element shows up, it resolves (pops) every smaller element still waiting.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Every element must be pushed onto the stack at least once to be considered — there's no shortcut even for the most favourable arrangement, since the algorithm must still confirm each element's next-greater status.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "This is the key amortised-analysis argument: although there's a nested-looking while-loop inside the main for-loop (popping elements off the stack), every single element is pushed exactly once and popped at most once across the ENTIRE algorithm, regardless of how the pops are distributed across iterations.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Even in the input that causes the MOST popping in a single iteration (e.g. a strictly decreasing sequence followed by one large value, which pops everything at once), the total work across the whole algorithm is still bounded by the same amortised argument.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "If the array is in strictly DECREASING order, every new element immediately becomes the new stack top without ever popping anything, but the stack itself still grows to hold all n elements by the end (with no next-greater found for any of them).",
          },
          {
            tag: "ul",
            items: [
              "This scenario actually maximises stack size, not minimises it — true best-case space (minimal stack depth) occurs for a strictly INCREASING array, where every new element immediately resolves and pops the previous one, keeping the stack at depth 1: O(1)",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "The output array (storing the next-greater result for every position) always requires O(n) space regardless of input order, and the stack itself can grow up to O(n) depending on the specific arrangement.",
          },
          {
            tag: "ul",
            items: [
              "Output array: O(n), always required",
              "Stack: up to O(n), depending on how many elements remain unresolved at any point during the scan",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "A strictly decreasing array (before any final large value, if any) causes every element to be pushed without being popped, growing the stack to its maximum possible size.",
          },
          {
            tag: "ul",
            items: [
      ...
      pseudoCodeandStepexplanation: [
        { tag: "h1", text: "Pseudocode & Step-by-Step Explanation" },
        {
          tag: "code",
          language: "text",
          text: `function nextGreaterElement(nums):
    n ← length(nums)
...
`,
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "A monotonic stack is a stack maintained so that its elements are always in strictly increasing OR strictly decreasing order from bottom to top — enforced by popping any elements that would violate that order before pushing a new one. It's less a single named algorithm and more a general TECHNIQUE that underlies Next Greater Element, Largest Rectangle in Histogram, Trapping Rain Water, and a wide family of 'find the nearest element satisfying some ordering condition' problems.",
        },
        {
          tag: "p",
          text: "Its power comes from a simple amortised-analysis fact: even though popping looks like it could create nested-loop O(n²) behaviour, every single element is pushed exactly once and popped AT MOST once across the algorithm's entire run, no matter how the pops are distributed — guaranteeing O(n) total work regardless of how 'busy' any individual iteration's popping looks.",
        },
        { tag: "h2", text: "When to reach for it" },
        {
          tag: "ul",
        ...
        },
        {
          ...
          rows: [
            [
              ...
              "Pop while new element > stack top's value",
            ],
            [
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "The single recurring template across every monotonic stack problem: for each new element, pop everything from the stack that the new element 'invalidates' or 'resolves', processing each popped element exactly once, then push the new element.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Every element must be pushed onto the stack at least once, regardless of how favourable the input arrangement is — there's no structural shortcut to avoid visiting every element.",
          },
          {
            tag: "ul",
            items: [
              "n elements, each pushed exactly once: O(n)",
              "This holds even for the input arrangement that minimises total popping work",
            ],
          },
        ],
        average: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Even the input arrangement that concentrates the MOST popping into a single iteration (e.g. a long monotonic run suddenly broken by one extreme value, popping everything at once) doesn't break the O(n) bound, since the amortised argument accounts for ALL pops across the entire run, not per-iteration.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "If every new element immediately resolves and pops the previous stack top (e.g. a strictly monotonic input matching the 'opposite' direction of what's being tracked), the stack never grows beyond depth 1.",
          },
          { tag: "ul", items: ["Stack depth stays at most 1 throughout: O(1)"] },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "For typical input, the stack holds a varying number of 'still waiting to be resolved' elements at any given point, which can range up to O(n) depending on the specific value arrangement.",
          },
          {
            tag: "ul",
            items: ["Stack: up to O(n) at its deepest point, depending on input distribution"],
          },
        ],
        worst: [
          { tag: "h2", text: "Worst Case Space — O(n)" },
          {
            tag: "p",
            text: "If the input is already monotonic in the 'wrong' direction (never triggering any pops, e.g. strictly decreasing input when looking for next-greater), every element remains on the stack simultaneously by the end.",
          },
          {
            tag: "ul",
            items: [
      ...
      pseudoCodeandStepexplanation: [
        ...
        {
          tag: "p",
          text: "Generic template — finding, for each index, the nearest index to its left with a SMALLER value (a 'previous smaller element' monotonic increasing stack):",
        },
        {
          tag: "code",
          language: "text",
          text: `function previousSmallerElement(nums):
    n ← length(nums)
    result ← array of size n, filled with −1
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "A common trick to avoid special-casing leftover bars still on the stack at the end: append a sentinel bar of height 0 to the end of the input — this guarantees every remaining bar on the stack gets popped and processed during the final iterations, with no separate cleanup loop needed.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Every bar must be pushed onto the stack at least once to be considered as a potential limiting height for some rectangle — there's no shortcut even for the most favourable height arrangement.",
          },
          {
            tag: "ul",
            items: [
              "n bars, each pushed exactly once: O(n)",
              "Best case still requires the full single pass to correctly compute every bar's maximal rectangle",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "Identical amortised argument to the general monotonic stack pattern: every bar is pushed exactly once and popped at most once across the entire algorithm, regardless of how pops are distributed across iterations.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Even the input arrangement causing the most popping in a single iteration (e.g. a strictly increasing sequence of heights followed by a single very short bar, popping everything at once) doesn't break the amortised O(n) bound.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "If heights are strictly decreasing, every new bar immediately triggers processing of the previous bar (since it's now shorter than what came before), keeping the stack from growing significantly.",
          },
          {
            tag: "ul",
            items: [
              "For strictly decreasing input, the stack stays shallow throughout: close to O(1) at any given moment, though area calculations still happen on every pop",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "For typical height arrangements, the stack holds a varying number of 'still relevant' bar indices at any point, which can range up to O(n) depending on the specific height pattern.",
          },
          {
            tag: "ul",
            items: [
              "Stack: up to O(n) at its deepest point, depending on the heights array's structure",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "If heights are strictly increasing (a 'staircase' shape), every bar remains on the stack simultaneously until the very end, since no shorter bar ever appears to trigger popping.",
          },
          {
            tag: "ul",
            items: [
      ...
      pseudoCodeandStepexplanation: [
        { tag: "h1", text: "Pseudocode & Step-by-Step Explanation" },
        {
          tag: "code",
          language: "text",
          text: `function largestRectangleArea(heights):

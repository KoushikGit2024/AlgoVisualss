...
export const ALGORITHMSNAV = [
  ...
  },
  {
    ...
    items:[
      { name: "Bubble Sort", href: "/algorithms/sorting/bubble-sort", type: "Easy" },
      { name: "Merge Sort", href: "/algorithms/sorting/merge-sort", type: "Medium" },
      { name: "Timsort", href: "/algorithms/sorting/tim-sort", type: "Hard" },
      { name: "Quick Sort", href: "/algorithms/sorting/quick-sort", type: "Medium" },
      { name: "Heap Sort", href: "/algorithms/sorting/heap-sort", type: "Medium" },
      { name: "Counting Sort", href: "/algorithms/sorting/counting-sort", type: "Medium" },
      { name: "Selection Sort", href: "/algorithms/sorting/selection-sort", type: "Easy" },
      { name: "Radix Sort", href: "/algorithms/sorting/radix-sort", type: "Medium" },

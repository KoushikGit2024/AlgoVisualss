const SORTING_SECTION = {
  ...
  about: [
    ...
    },
    {
      tag: "note",
      variant: "tip",
      text: "When the keys are small bounded integers (e.g. sorting exam scores 0–100, or single bytes), counting or radix sort will outperform any comparison sort by skipping the n log n lower bound entirely.",
    },
  ],
  ...
  items: [
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Bubble Sort repeatedly steps through the array, comparing each pair of adjacent elements and swapping them if they're in the wrong order. Larger elements 'bubble up' toward the end of the array on each pass, exactly like air bubbles rising through water — hence the name.",
        },
        {
          tag: "p",
          text: "It is rarely used in production code due to its O(n²) average and worst-case time, but it remains pedagogically valuable as the simplest possible sorting algorithm to reason about, and the optimised version (with an early-exit flag) actually achieves O(n) on already-sorted input, which is faster in that one specific case than several 'better' algorithms.",
        },
        ...
        },
        {
          tag: "note",
          variant: "info",
          text: "Use it only for teaching, for verifying a tiny array by hand, or when code simplicity matters far more than runtime on inputs of trivial size.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Achieved only with the early-exit optimisation, on an already-sorted array: a single pass makes zero swaps, the 'swapped' flag stays false, and the algorithm terminates immediately.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "For a randomly ordered array, roughly half of all adjacent pairs are initially out of order, and the algorithm needs close to the full n − 1 passes to fully sort, each pass comparing roughly the remaining unsorted length.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "The worst case is a reverse-sorted array: every single adjacent pair is out of order on every pass, forcing the maximum possible number of comparisons and swaps.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Sorting happens entirely in-place on the original array; only a loop counter and a temporary swap variable are needed.",
          },
          {
            tag: "ul",
            items: [
              "Loop indices i, j — O(1)",
              "One temp variable for swapping — O(1)",
              "Boolean swapped flag — O(1)",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "No auxiliary array is ever created — memory usage is identical regardless of input distribution.",
          },
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Even maximal swapping doesn't allocate new memory — swaps happen in-place within the existing array.",
          },
          {
            tag: "ul",
            items: [
              "No recursion, no auxiliary structures — space stays O(1) regardless of swap count",
            ],
          },
        ],
      },
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Merge Sort is a divide-and-conquer algorithm invented by John von Neumann in 1945. It recursively splits the array in half until each piece has one element (trivially sorted), then repeatedly merges sorted halves back together into larger and larger sorted runs until the whole array is sorted.",
        },
        {
          tag: "p",
          text: "Its defining strength is a guaranteed O(n log n) bound in every case — best, average, and worst — making it the algorithm of choice whenever predictable performance matters more than average-case speed, and it's the classic example used to teach the Master Theorem for analysing recursive algorithms.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "Merge Sort is the standard choice when stability is required and worst-case guarantees matter more than average-case constant factors — e.g. sorting by one key after already having sorted by another.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Merge Sort always recurses to the same depth and always merges every pair of runs in full, regardless of whether the input is already sorted — there's no early exit, so best case equals worst case.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "The recurrence T(n) = 2T(n/2) + O(n) — split into two halves, recursively sort each, then merge in linear time — solves to O(n log n) by the Master Theorem, regardless of the values in the array.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Unlike Quick Sort, there is no input arrangement that degrades Merge Sort's performance — the divide step always splits evenly by position (not by value), so the recursion tree is always perfectly balanced.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "The merge step needs a temporary buffer to hold the merged result before copying it back, sized to the portion of the array being merged — summing to O(n) across the whole algorithm at any given recursion level.",
          },
          {
            tag: "ul",
            items: [
              "Temporary merge buffer: O(n) total auxiliary array space",
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Space usage is identical for every input — it depends only on array length, not on value order, since the merge buffer size is fixed by the algorithm's structure.",
          },
          {
            tag: "ul",
            items: [
              "O(n) auxiliary array (standard top-down implementation)",
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "No input increases space usage beyond the standard merge buffer — this is the same in every case, a useful contrast to Quick Sort's space variability.",
          },
          {
            tag: "ul",
            items: [
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Timsort identifies naturally occurring ascending or descending 'runs' in the data, extends short runs up to a minimum length using Insertion Sort, then merges runs together using a carefully tuned merge strategy (galloping mode) that adapts based on how lopsided the two runs being merged are.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "info",
          text: "Timsort's worst-case O(n log n) guarantee, combined with its excellent real-world performance on partially-sorted data, is why it has become the standard library default in multiple major languages rather than plain Quick Sort or Merge Sort.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "On already fully-sorted (or fully reverse-sorted, which Timsort detects and reverses in O(n)) input, the entire array is identified as a single run, requiring no merging at all.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "For genuinely random data, Timsort behaves like a tuned Merge Sort: it identifies many short runs (extended to a minimum run length via Insertion Sort), then merges them pairwise using a balanced merge strategy.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Timsort's merge strategy uses a 'stack invariant' on run lengths to guarantee balanced merging even on adversarial inputs, preventing the kind of degenerate unbalanced merging that could otherwise blow up the runtime.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Even with a single run requiring no merging, Timsort allocates a temporary merge buffer up front sized for the worst case it might encounter.",
          },
          {
            tag: "ul",
            items: [
              "Temp merge buffer: up to O(n/2) in the standard implementation",
              "Run-length stack: O(log n) entries",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "The merge buffer size scales with the size of the runs being merged, bounded above by O(n) for the final merge of two roughly-equal halves.",
          },
          {
            tag: "ul",
            items: [
              "Temporary buffer for merging: O(n)",
              "Run stack tracking pending merges: O(log n)",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "No input increases memory usage beyond the standard merge buffer, which is the same structural cost as plain Merge Sort.",
          },
          {
            tag: "ul",
            items: [
              "O(n) auxiliary space for merge buffers — same as Merge Sort",
              "O(log n) for the run-tracking stack",
            ],
          },
        ],
      },
      ...
      pseudoCodeandStepexplanation: [
        ...
        {
          tag: "p",
          text: "Simplified right-level pseudocode (real implementations include galloping mode and a precise merge-stack invariant, omitted here for clarity):",
        },
        {
          tag: "code",
          language: "text",
          text: `MIN_RUN ← 32   // tuned constant, typically 32–64
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Quick Sort, devised by Tony Hoare in 1959, is a divide-and-conquer algorithm that picks a 'pivot' element and partitions the array so that everything smaller than the pivot ends up to its left and everything larger ends up to its right, then recursively sorts each side. Unlike Merge Sort, all the real work happens in the partition (divide) step rather than the combine step — there's nothing left to merge once both sides are sorted.",
        },
        {
          tag: "p",
          text: "It is usually the fastest general-purpose comparison sort in practice due to excellent cache locality (in-place partitioning) and left constant factors, despite having a theoretically worse worst case than Merge Sort or Heap Sort.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "warning",
          text: "Always-pick-first-element pivoting is a classic interview trap: it degrades to O(n²) on already-sorted arrays, which are extremely common in real-world data. Randomised or median-of-three pivoting avoids this.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "The best case occurs when every chosen pivot splits its partition into two exactly equal halves, producing the same balanced recursion tree shape as Merge Sort.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Even without perfectly balanced splits, a randomly chosen pivot on random or randomised input produces splits that are 'good enough' on average — the expected recursion depth remains O(log n).",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "If the pivot is consistently the smallest or largest remaining element (e.g. always picking the first element on an already-sorted array), each partition only removes one element from consideration, degenerating into something resembling Selection Sort.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Sorting happens in-place via swaps; the only meaningful memory cost is the recursion call stack, which is shallow when partitions are balanced.",
          },
          {
            tag: "ul",
            items: [
              "Balanced recursion: depth O(log n)",
              "Each stack frame: O(1) — just bounds (left, right)",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "On average, recursion depth stays logarithmic because tail-call optimisation (recursing on the smaller partition first) bounds the call stack even when splits aren't perfectly even.",
          },
          {
            tag: "ul",
            items: [
              "With the 'recurse on smaller half first' optimisation, stack depth is provably O(log n) even for unequal splits",
              "No auxiliary array — purely in-place swapping",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "Without the smaller-half-first optimisation, a maximally unbalanced partition sequence (1 element removed per level) produces n levels of recursion.",
          },
          {
            tag: "ul",
            items: [
      ...
      pseudoCodeandStepexplanation: [
        ...
        { tag: "p", text: "Lomuto partition scheme, with the last element as pivot:" },
        {
          tag: "code",
          language: "text",
          text: `function quickSort(arr, left, right):
    if left < right:
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "Heap Sort's main practical niche is when you need an in-place O(n log n) guarantee with zero risk of O(n²) degradation and can tolerate worse real-world constant factors than Quick Sort.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Building the initial heap and extracting all n elements always costs the same amount of work regardless of the initial array order — there's no early-exit shortcut for sorted input.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Every extraction always requires a full sift-down to restore the heap invariant, and this cost doesn't meaningfully vary with the input's value distribution — it's driven by tree height, which depends only on n.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Heap Sort has no adversarial input that degrades its performance — sift-down always costs O(log n) bounded strictly by tree height, regardless of value arrangement.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "The heap is built directly within the original array using index arithmetic (parent = (i-1)/2, children = 2i+1, 2i+2) — no separate heap structure is allocated.",
          },
          {
            tag: "ul",
            items: [
              "Heap lives in-place inside arr — O(1) extra",
              "A few loop counters for sift-down/sift-up — O(1)",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "Memory usage never depends on input values — it's structurally fixed by the in-place array-based heap representation.",
          },
          {
            tag: "ul",
            items: [
              "No auxiliary array, unlike Merge Sort",
              "Iterative sift-down avoids recursion-stack growth in standard implementations",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "No input pattern increases memory beyond the fixed handful of scalars used during heap construction and extraction.",
          },
          {
            tag: "ul",
            items: [
              "O(1) regardless of n — this is Heap Sort's key space advantage over Merge Sort's O(n)",
            ],
          },
        ],
      },
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Counting Sort is a non-comparison sorting algorithm that works by counting the number of occurrences of each distinct key value, then using those counts to determine each element's final position directly — without ever comparing two elements to each other.",
        },
        {
          tag: "p",
          text: "Because it sidesteps comparisons entirely, it isn't bound by the Ω(n log n) comparison-sort lower bound, and instead runs in O(n + k) time, where k is the range of possible key values. This makes it extremely fast when k is small relative to n (e.g. sorting grades 0–100, or single-byte values 0–255), but impractical when k is very large or the keys are not small integers.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "warning",
          text: "If k (the range of key values) is much larger than n, Counting Sort's O(n + k) bound becomes worse than a comparison sort's O(n log n) — always check the key range before reaching for it.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Counting Sort always performs the same fixed sequence of passes regardless of input order — there's no early-exit or input-dependent branching, so best case equals worst case exactly.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Since every step is a straightforward linear scan over either the input (size n) or the count array (size k), there is no concept of 'average' differing from best/worst — the algorithm's cost structure is entirely deterministic given n and k.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "There's no adversarial input that makes Counting Sort slower than its standard bound — every operation is a fixed-cost linear pass, with no comparisons or recursive branching that could blow up.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "A count array of size k is always needed to track frequency per key, and a separate output array of size n is typically used to assemble the stable result.",
          },
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Memory usage is fixed by n and k alone, not by the values' distribution within that range.",
          },
          {
            tag: "ul",
            items: [
              "Count array (size k) + output array (size n), both allocated regardless of input order",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "No input increases the space beyond the fixed count and output arrays — space usage is entirely a function of the problem parameters n and k.",
          },
          {
            tag: "ul",
            items: [
      ...
      pseudoCodeandStepexplanation: [
        { tag: "h1", text: "Pseudocode & Step-by-Step Explanation" },
        {
          tag: "code",
          language: "text",
          text: `function countingSort(arr, k):           // keys assumed in range [0, k]
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Selection Sort divides the array into a sorted prefix and an unsorted suffix. On each pass, it scans the entire unsorted suffix to find the minimum element, then swaps it into the next position of the sorted prefix — growing the sorted region by exactly one element per pass.",
        },
        {
          tag: "p",
          text: "It is rarely the right choice for large datasets due to its unconditional O(n²) comparisons even on already-sorted input, but it has one genuinely useful property: it performs at most n − 1 swaps total, the fewest of any comparison-based sort, which matters when swaps are expensive (e.g. writing to flash memory or very large records) even though comparisons are cheap.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "info",
          text: "Choose Selection Sort specifically when minimising the NUMBER of writes matters more than minimising comparisons — for example, sorting data on a medium with expensive or limited write cycles.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Selection Sort always scans the entire remaining unsorted suffix to find the minimum, even if the array is already perfectly sorted — there is no early-exit mechanism.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Since the comparison count is fixed by the algorithm's structure (always scan the full remaining suffix) and not by the values encountered, average case is identical to best and worst case in comparison count.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "The comparison count for Selection Sort is provably constant across all inputs of a given length — the algorithm structurally requires scanning the full unsorted suffix every single pass.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Sorting is entirely in-place — only a few index variables track the current pass boundary and the running minimum's position.",
          },
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Memory usage never grows with n or with input value distribution — it's always the same fixed handful of scalars.",
          },
          {
            tag: "ul",
            items: ["No auxiliary array — identical memory footprint regardless of input"],
          },
        ],
        worst: [
          { tag: "h2", text: "Worst Case Space — O(1)" },
          {
            tag: "p",
            text: "Even the maximum possible n − 1 swaps don't require any additional memory beyond a single temp variable used during each swap.",
          },
      ...
      pseudoCodeandStepexplanation: [
        { tag: "h1", text: "Pseudocode & Step-by-Step Explanation" },
        {
          tag: "code",
          language: "text",
          text: `function selectionSort(arr):
    n ← length(arr)
    for i from 0 to n − 2:
        minIndex ← i
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Radix Sort sorts integers (or fixed-length strings) by processing individual digits, from least-significant digit (LSD) to most-significant digit (MSD), using a stable sub-sort — almost always Counting Sort — at each digit position. After processing all d digits, the array is fully sorted.",
        },
        {
          tag: "p",
          text: "It is another non-comparison sort, and its runtime O(d(n + k)) can beat O(n log n) when d (the number of digits) is small relative to log n — for example, sorting 32-bit integers takes at most a handful of passes regardless of how many billions of elements there are, as long as a sensible base/radix is chosen.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "Radix Sort is the standard choice for sorting large arrays of fixed-width integers (IDs, IP addresses, fixed-length strings) where it reliably beats comparison sorts in practice.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Radix Sort always performs exactly d full passes regardless of input order — each pass runs a complete Counting Sort over all n elements, so there is no early-exit shortcut for already-sorted data.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Like Counting Sort, every pass of Radix Sort performs the exact same fixed sequence of operations regardless of key value distribution, so there's no meaningful difference between average and worst case.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "There is no adversarial input arrangement that increases Radix Sort's cost beyond its standard bound, since every digit pass does fixed O(n + k) work regardless of value order.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Each digit pass reuses the same Counting Sort machinery: a count array of size k (the radix) and an output array of size n, both reallocated or reused per pass.",
          },
        ...
        average: [
          ...
          {
            tag: "p",
            text: "Memory usage per pass is fixed by n and k, and passes can reuse the same buffers, so total space doesn't multiply by d — it stays O(n + k) regardless of how many digit passes run.",
          },
          {
            tag: "ul",
            items: [
              "Buffers are reused across the d passes rather than allocated d times, so space stays O(n + k), not O(d(n + k))",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "No input increases space beyond the reusable count and output buffers shared across all digit passes.",
          },
          {
            tag: "ul",
            items: [
              "O(n) output buffer + O(k) count buffer, reused per digit pass — O(n + k) total regardless of d",
            ],
          },
        ],
      },
      ...
      pseudoCodeandStepexplanation: [
        ...
        {
          tag: "p",
          text: "LSD (least-significant-digit-first) Radix Sort for non-negative integers:",
        },
        {
          tag: "code",
          language: "text",
          text: `function radixSort(arr):
...
function countingSortByDigit(arr, exp):
    ...
    copy output back into arr`,
        ...
        {
          tag: "p",
          text: "Correctness rests on a key claim: after sorting by digit position i (using a stable sort and considering only digits 0..i), the array is correctly sorted with respect to the number formed by digits 0..i, with ties broken by original input order. By induction on i, once digit position d−1 (the most significant) is processed, the array is sorted by the full numeric value, since every more-significant digit dominates the comparison and stability preserves the correct tie-breaking established by all the less-significant passes before it.",
        },
      ],
      codes: {
        "c++": `#include <iostream>
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Insertion Sort builds the sorted array one element at a time, exactly the way most people sort a hand of playing cards: take the next unsorted card and insert it into its correct position among the already-sorted cards to its left, shifting larger cards rightward to make room.",
        },
        {
          tag: "p",
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "Insertion Sort is the right default for small arrays (typically under ~16–64 elements) and for data that's already mostly sorted, which is exactly why production sort implementations switch to it below a size threshold.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "On an already-sorted array, every new element is already greater than or equal to everything before it, so the inner shifting loop terminates after a single comparison for each outer iteration.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "For a randomly ordered array, each new element needs to shift past roughly half of the already-sorted prefix on average before finding its correct position.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "The worst case is a reverse-sorted array: every new element is smaller than everything already placed, forcing it to shift all the way to the front of the sorted prefix.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Sorting happens entirely in-place by shifting elements within the original array — only one temporary variable holds the element currently being inserted.",
          },
          {
            tag: "ul",
            items: ["key (the element being inserted) — O(1)", "i, j loop indices — O(1)"],
          },
        ],
        average: [
          { tag: "h2", text: "Average Case Space — O(1)" },
          {
            tag: "p",
            text: "Memory usage is identical for any input, since shifting elements within the array requires no additional storage proportional to n.",
          },
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "Even when every element requires the maximum possible number of shifts, no extra memory beyond the single key variable is needed.",
          },
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Bucket Sort distributes elements into a number of 'buckets' based on their value range, sorts each bucket individually (typically with Insertion Sort, since buckets are expected to be small), and then concatenates the sorted buckets in order to produce the final sorted array.",
        },
        {
          tag: "p",
          text: "It achieves linear expected time when the input is uniformly distributed across a known range — each bucket then receives roughly n/k elements, so sorting all buckets costs O(n) total instead of O(n log n). It degrades to O(n²) if all elements land in a single bucket (e.g. highly skewed or clustered data), making the bucket boundary strategy critical to its performance.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "warning",
          text: "Bucket Sort assumes you know enough about the input distribution to choose sensible bucket ranges — for unknown or adversarial distributions, a comparison sort with a guaranteed bound is safer.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "When input is uniformly distributed across the bucket ranges, each of the k buckets receives roughly n/k elements, and sorting each small bucket with Insertion Sort is fast since bucket sizes are small.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "For a reasonably uniform distribution, the expected total cost across all buckets remains linear because the sum of squared bucket sizes is minimised when sizes are balanced — a standard result from the analysis of hashing-with-chaining, which Bucket Sort closely resembles.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "If the input distribution is highly skewed and every element lands in the same single bucket, that one bucket must be sorted with Insertion Sort over all n elements, degenerating to the same worst case as plain Insertion Sort.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Every element is copied into exactly one bucket, and k bucket containers must be allocated regardless of how the data ends up distributed.",
          },
          {
            tag: "ul",
            items: ["n elements total across all buckets: O(n)", "k bucket containers: O(k)"],
          },
        ],
        average: [
          { tag: "h2", text: "Average Case Space — O(n + k)" },
          {
            tag: "p",
            text: "Space usage is fixed by n (total elements) and k (number of buckets), regardless of how evenly the elements are distributed among them.",
          },
          {
            tag: "ul",
            items: [
              "Same O(n + k) bound holds for any distribution, since total element count and bucket count don't change",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "Even in the degenerate single-bucket case, total space is unchanged — one bucket simply holds all n elements instead of them being spread out.",
          },
          {
            tag: "ul",
            items: [
              "O(n) for element storage (concentrated or spread) + O(k) for bucket containers — space bound doesn't change even though time degrades",
            ],
          },
        ],
      },
      ...
      pseudoCodeandStepexplanation: [
        ...
        {
          tag: "p",
          text: "Bucket Sort for floating-point values uniformly distributed in [0, 1):",
        },
        {
          tag: "code",
          language: "text",
          text: `function bucketSort(arr):
    n ← length(arr)
    ...
    return result`,
        ...
        {
          tag: "p",
          text: "Correctness depends on two facts: first, the bucket-index function must be monotonic — if x < y then x's bucket index is ≤ y's bucket index, ensuring no element in an earlier bucket is ever greater than an element in a later bucket. Second, each bucket is independently sorted before concatenation. Together, these guarantee that concatenating the buckets in order produces a fully sorted array, since within-bucket order is correct (by the bucket's own sort) and across-bucket order is correct (by the monotonic mapping).",
        },
      ],
      codes: {
        "c++": `#include <iostream>
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "Shell Sort, invented by Donald Shell in 1959, is a generalisation of Insertion Sort that first sorts elements far apart from each other (using a large 'gap'), then progressively reduces the gap, sorting closer and closer pairs, until a final gap of 1 performs an ordinary Insertion Sort — but on data that's already nearly sorted, making that final pass very fast.",
        },
        {
          tag: "p",
          text: "Its purpose is to fix Insertion Sort's biggest weakness: small out-of-place elements near the end of the array normally require many small shifts to reach their correct position. Sorting with a large gap first lets such elements move long distances in a single comparison-swap, dramatically reducing the total shifting work needed by the time the gap reaches 1.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "info",
          text: "Shell Sort's exact complexity is one of the few sorting algorithms whose tight worst-case bound is still an open or sequence-dependent question — the bound quoted depends entirely on which gap sequence is used.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "On already-sorted input, each gapped Insertion Sort pass requires only a single comparison per element (just like ordinary Insertion Sort's best case), and there are O(log n) gap passes with a well-chosen sequence.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "With Shell's original gap sequence (halving each time: n/2, n/4, ..., 1), empirical and theoretical analysis gives an average case around O(n^1.5) to O(n log² n) depending on the exact sequence — better gap sequences (e.g. Sedgewick's) tighten this further.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "With the original Shell gap sequence (powers of 2), certain adversarial inputs can force each gapped pass to do nearly maximal work, giving an O(n²) worst case — better-chosen sequences like Sedgewick's reduce this worst-case bound substantially.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Like Insertion Sort, Shell Sort operates entirely in-place — the gap sequence is either computed on the fly or stored in a small fixed-size array.",
          },
          {
            tag: "ul",
            items: [
              "gap, i, j loop variables — O(1)",
              "Optional precomputed gap sequence array — O(log n), negligible",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "Memory usage is identical regardless of input values — it depends only on the (typically small, O(log n)) gap sequence, not on n directly for the working memory.",
          },
          {
            tag: "ul",
            items: [
              "No auxiliary array proportional to n — same in-place footprint as Insertion Sort",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "No input increases memory usage beyond the fixed gap-tracking variables, regardless of how many shifts occur during any given pass.",
          },
...
fn main() {
    ...
    ════════════════════════════════════════════════════════════════════ */
    {
      ...
      about: [
        ...
        {
          tag: "p",
          text: "It also falls back to Insertion Sort for small sub-arrays (typically below ~16 elements), exactly like Timsort does, since Insertion Sort's left overhead beats recursive divide-and-conquer at small sizes. This three-way hybrid (Quick Sort + Heap Sort + Insertion Sort) is the algorithm behind C++'s std::sort and .NET's Array.Sort, making it arguably the most widely deployed general-purpose comparison sort in production systems today.",
        },
        { tag: "h2", text: "Key properties" },
        {
          tag: "ul",
        ...
        },
        {
          tag: "note",
          variant: "tip",
          text: "Introsort is the practical answer to 'why not just always use Quick Sort' — it gets Quick Sort's real-world speed with none of its worst-case risk, which is exactly why it backs the standard library sort in C++ and .NET.",
        },
      ],
      ...
      timeComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "Identical to Quick Sort's best case — when partitions are balanced, recursion never approaches the depth threshold, so the algorithm runs as plain Quick Sort with O(n log n) total work.",
          },
          {
            tag: "ul",
            items: [
        ...
        average: [
          ...
          {
            tag: "p",
            text: "For typical inputs, Introsort behaves exactly like Quick Sort with good pivot selection, achieving the same expected O(n log n) bound, while the depth-monitoring safeguard sits idle (or rarely triggers) since random/typical pivots rarely produce pathologically unbalanced splits.",
          },
          {
            tag: "ul",
            items: [
        ...
        worst: [
          ...
          {
            tag: "p",
            text: "This is Introsort's entire reason for existing: the moment recursion depth would exceed the threshold (signalling Quick Sort is degenerating toward its O(n²) worst case), the algorithm switches that sub-array to Heap Sort, which has a proven O(n log n) worst-case bound regardless of input.",
          },
          {
            tag: "ul",
            items: [
      ...
      spaceComplexityCalculation: {
        ...
        best: [
          ...
          {
            tag: "p",
            text: "When operating as Quick Sort with balanced partitions, the recursion stack depth stays logarithmic, identical to Quick Sort's own best case.",
          },
          {
            tag: "ul",
            items: [
              "Recursion stack: O(log n)",
              "No Heap Sort fallback triggered, so no additional heap-related space needed",
            ],
          },
        ],
        average: [
          ...
          {
            tag: "p",
            text: "Average space usage matches Quick Sort's, since the depth-limiting mechanism rarely triggers on typical inputs and Heap Sort (when it does trigger) operates in-place with O(1) extra space anyway.",
          },
          {
            tag: "ul",
            items: [
              "O(log n) for the Quick-Sort-style recursion stack",
              "Heap Sort fallback (if triggered) adds no extra space beyond O(1), since Heap Sort is itself in-place",
            ],
          },
        ],
        worst: [
          ...
          {
            tag: "p",
            text: "Because the depth threshold caps Quick-Sort-style recursion at O(log n) levels before forcing a switch to in-place Heap Sort, the worst-case space never reaches Quick Sort's pathological O(n) call-stack scenario.",
          },
          {
            tag: "ul",
            items: [

...
export default function HomePage() {
  return (
    <div className="relative flex flex-col flex-1 items-center bg-(--bg) overflow-hidden selection:bg-[color-mix(in_srgb,var(--accent)_20%,transparent)] selection:text-(--text)">
      <SEO
        title="Interactive Algorithm & C++ Code Visualizer"
        description="Interactive DSA visualizer and algorithm simulator. Master Data Structures and Algorithms with real-time C++ code execution, step-by-step animations, dynamic memory tracking, and modern dark UI. Explore sorting, graphs, trees, and dynamic programming."
        ...
        jsonLd={{
          ...
          description:
            "Interactive DSA visualizer and algorithm simulator. Master Data Structures and Algorithms with real-time C++ code execution, step-by-step animations, dynamic memory tracking, and modern dark UI. Explore sorting, graphs, trees, and dynamic programming.",
          ...
          educationalUse: ["Self Study", "Programming Education", "Computer Science Education"],
          featureList: [

...
export function CategoryIcon({ name, hover = false }: CategoryIconProps) {
  switch (name) {
    ...
    case "Bits":
      return hover ? (
        <svg viewBox="0 0 64 64" fill="currentColor">
          <text x="7" y="40" fontSize="18" fontFamily="monospace">
            10<tspan fill="#34D399">01</tspan>
          </text>
        </svg>
      ) : (
        <svg viewBox="0 0 64 64" fill="currentColor">
    ...
    case "Sorting":
      return hover ? (
        <svg viewBox="0 0 64 64" fill="#34D399">
          ...
          <path
            d="M 60 56 L 60 16 L 56 22 M 60 16 L 64 22"
            stroke="#34D399"
            strokeWidth="2"
            fill="none"
          />
    ...
    case "String":
      return hover ? (
        <svg viewBox="0 0 64 64" fill="currentColor">
          <text x="8" y="42" fontSize="26" fontFamily="monospace">
            A<tspan fill="#34D399">a</tspan>
          </text>
